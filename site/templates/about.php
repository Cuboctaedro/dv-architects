...
<section class="w-full ">
    ...
    <div class="flex flex-row flex-wrap border-b border-solid grayborder">
        <div class="w-full lg:w-1/2 ">
            <article class="about generated p-4 sm:p-6 md:p-8 lg:border-r border-b border-solid grayborder">
                <h2 class="font-titles text-2xl leading-tight mb-4 sm:mb-6 md:mb-8"><?= t('profile') ?></h2>
                <?= $page->text()->kt() ?>
            </article>
            <article class="p-4 sm:p-6 md:p-8 lg:border-r border-solid grayborder">
        ...
        <div class="w-full lg:w-1/2">
            <section class="p-4 sm:p-6 md:p-8 generated border-b border-solid grayborder">
