...
<picture>
    ...
    <source media="(max-width: 1023px)" data-srcset="<?= $pic->thumb([ 'width'=> 1024])->url(); ?>">
    <source media="(max-width: 1600px)" data-srcset="<?= $pic->thumb([ 'width'=> 1200])->url(); ?>">
    <source media="(min-width: 1601px)" data-srcset="<?= $pic->thumb([ 'width'=> 1600])->url(); ?>">
